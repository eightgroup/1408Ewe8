...
<link type="text/css" rel="stylesheet" href="<?php echo URL?>/views/assets/bootstrap.css">
<link type="text/css" rel="stylesheet" href="<?php echo URL?>/views/assets/font-awesome.css">
<link type="text/css" rel="stylesheet" href="<?php echo URL?>/views/assets/common(1).css">
<script type="text/javascript" src="<?php echo URL?>/views/assets/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="<?php echo URL?>/views/assets/bootstrap.js"></script>
<script type="text/javascript" src="<?php echo URL?>/views/assets/common(2).js"></script>
<script type="text/javascript" src="<?php echo URL?>/views/assets/emotions.js"></script>
<script type="text/javascript">
cookie.prefix = '6e34_';
</script>
</head>
<body>
<script type="text/javascript" src="<?php echo URL?>/views/assets/jquery-ui-1.10.3.min.js"></script>
<script type="text/javascript">
	var pIndex = 1;
	...
	function saveMenu() {
		...
		dat += ']';
		var json='{"button":'+dat+"}";
		$.post("<?php echo URL?>/web/menu/addll",{json:json},function(date){
			alert(date)
		})
		return false;
		$('#do').val(dat);
